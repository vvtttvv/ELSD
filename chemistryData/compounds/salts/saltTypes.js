...
export const knownSalts = {
  ...
  "CrCl3": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  ...
  "NH4Cl": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "(NH4)2SO4": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "FeCl2": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "NaBr": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "KBr": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "Pb(NO3)2": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "KI": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "PbI2": [saltCategories.NORMAL, saltCategories.INSOLUBLE],
  "NaNO3": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "KNO3": [saltCategories.NORMAL, saltCategories.SOLUBLE],
  "Ca(NO3)2": [saltCategories.NORMAL, saltCategories.SOLUBLE],
