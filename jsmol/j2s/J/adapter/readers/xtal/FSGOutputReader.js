...
var s = JS.SymmetryOperation.getXYZFromMatrixFrac(mop, false, false, false, true, true, "xyz") + JS.SymmetryOperation.getSpinString(mspin, true) + (this.isCoplanar ? "+" : "");
...
}if (this.elementNumbers != null && id <= this.elementNumbers.length) {
...
m2g0.transpose33();
var abcm = JS.SymmetryOperation.getXYZFromMatrixFrac(m2g0, false, false, false, true, true, "abc");
...
this.spinFrame = this.calculateSpinFrame();
...
m4.mul2(m4, msfInv);
m4.mul2(msf, m4);
}var s = JS.SymmetryOperation.getXYZFromMatrixFrac(m4, false, false, false, false, true, "uvw");
...
m4.transpose();
return JS.SymmetryOperation.getXYZFromMatrixFrac(m4, false, false, false, true, true, "abc");
});
});
