...
var sf = this.parseUvwMath(this.field);
...
this.spinFrame = sf;
}this.addCellType("spin", sf, false);
this.field = this.spinFrame;
this.spinFrame = this.spinFrame.$replace('"', ' ').trim();
tag = "spinFrame";
break;
...
this.field = this.addSpinFrameExt("coldir", true);
break;
